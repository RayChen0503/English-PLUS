...
export function errorMessage(code) {
  return {
    ...
    INVALID_OBJECT_KEY: "證明檔連結格式不正確，請重新整理後再試。",
    EVIDENCE_STORAGE_NOT_CONFIGURED: "證明檔儲存服務尚未正確設定。",
    EVIDENCE_READ_FAILED: "暫時無法讀取這份證明檔。",
    VOLUNTEER_APPLICATION_LOOKUP_FAILED: "暫時無法核對這份證明檔的申請資料。",
    AUTH_TOKEN_UNAVAILABLE: "登入憑證已失效，請重新登入管理台。",
    NETWORK_ERROR: "無法連線至證明檔服務，請確認網路後再試。",
    EMPTY_EVIDENCE_RESPONSE: "證明檔內容為空，請請申請人重新上傳。",
    INVALID_EVIDENCE_PREVIEW_URL: "證明檔檢視連結不正確，請重新整理後再試。",
    EVIDENCE_PREVIEW_TICKET_REQUIRED: "證明檔檢視連結已失效，請回管理台重新開啟。",
    INVALID_EVIDENCE_PREVIEW_TICKET: "證明檔檢視連結無效，請回管理台重新開啟。",
    EXPIRED_OR_INVALID_EVIDENCE_PREVIEW_TICKET: "證明檔檢視連結已過期，請回管理台重新開啟。",
